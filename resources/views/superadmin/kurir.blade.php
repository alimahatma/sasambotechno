                    ...
                    <table class="table table-striped" id="table1">
                        ...
                        <tbody>
                            ...
                            <tr class="text-center">
                                <td><?= $i++ ?></td>
                                <td>{{$val->nama_kurir}}</td>
                                <td>{{$val->jenis_kurir}}</td>
                                <td>
                                    <div class="d-flex justify-content-center">
                                        <div class="col-md-6 col-lg-3">
                                            <button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#modalUpdate{{$val->kurir_id}}">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-12 mt-1">
                            <h6>Nama kurir</h6>
                            <input class="form-control" type="text" name="nama_kurir" placeholder="nama kurir" aria-label="default input example">
                        </div>
                        <div class="col-12 mt-1">
                            <h6>Jenis kurir</h6>
                            <input class="form-control" type="text" name="jenis_kurir" placeholder="input jenis kurir" aria-label="default input example">
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-12 mt-1">
                            ...
                            <h6>Nama kurir</h6>
                            <input class="form-control" type="text" value="{{$row->nama_kurir}}" name="nama_kurir" placeholder="nama kurir" aria-label="default input example">
                        </div>
                        <div class="col-12 mt-1">
                            <h6>Jenis kurir</h6>
                            <input class="form-control" type="text" value="{{$row->jenis_kurir}}" name="jenis_kurir" placeholder="input jenis kurir" aria-label="default input example">
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
